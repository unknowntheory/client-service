...
const readable = fs.createReadStream('./../five.csv');
...
readable.pipe(
  ...
  let test = arr.map((entry, i)=>{
    let index = {index: {_index: 'sandbox', _type: 'product', _id: i}};
    console.log('mapped');
    return [index, entry];
  });
...
// {index: {_index: 'sandbox', _type: 'product', _id: i}},
// {86019,'Rustic Steel Pants','lorem ispum tata',394}
